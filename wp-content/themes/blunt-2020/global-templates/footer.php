<div class="wrapper" id="wrapper-footer">
    ...
    array(
            ...
            <div class="row mt-5 mt-lg-5 bottom-row">
                <div class="col-12 col-lg-7 site-branding left mb-4 mb-lg-0">
                    <img style="max-width:65px;height:auto;"
                        src="<?php echo get_template_directory_uri(); ?>/img/blunt-logo.svg"
                        class="mb-3 img-fluid" alt="Blunt Mag">
                ...
                <div class="col-12 col-lg-5 right">
                    <div class="d-flex align-top align-items-start">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/flag.svg"
                            class=" " alt="Torres Strait Islander Flag">
                        <p>Blunt Magazine acknowledges the Australian Aboriginal and Torres Strait Islander peoples as
                            the
                            first inhabitants of the nation and the traditional custodians of the lands where we live,
                            learn
                            and work.</p>
                    </div>
                </div>
