...
if ( ! function_exists( 'understrap_posted_on' ) ) {
	...
	function understrap_posted_on() {
		...
		if ( $categories_list && understrap_categorized_blog() ) {
			...
			$cats = sprintf( '<span class="cat-links">' . esc_html__( '%s', 'understrap' ) . '</span><br>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}
		...
		echo $cats . $byline . $posted_on ; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
}
	...
	function understrap_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $tags_list ) {
				...
				printf( '<div class="tags-links">' . esc_html__( 'TAGS %s', 'understrap' ) . '</div>', $tags_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
		}
...
function show_cats(){
		...
		if ( $categories_list && understrap_categorized_blog() ) {
			/* translators: %s: Categories of current post */
			$cats = sprintf( '<div class="cat-links">' . esc_html__( '%s', 'understrap' ) . '</div>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}
		echo $cats;
}
